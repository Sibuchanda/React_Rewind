...
export const Darklight = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`logo ml-10 rounded-full ${
      ...
      <section>
        <div
          className={`container1 flex flex-col items-center mt-20 ${
            theme === "light" ? "bg-gray-100" : "bg-black"
          }`}
        >
          <h1
        ...
        <div
          className={`container2 h-auto flex flex-col ${
            theme === "light" ? "bg-gray-100" : "bg-black"
          }`}
        >
          <h1
            className={`font-bold text-6xl text-center mt-6 ${
              theme === "light" ? "text-black" : "text-white"
            }`}
          >
            Services
